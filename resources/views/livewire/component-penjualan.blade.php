...
<div class="card card-info col-md-4 mr-md-5">
    <div class="card-header">
      <h3 class="card-title">Cari Nama Pasangan</h3>
    </div>
    <div class="card-body">
      <div class="form-group">
        <label >Masukkan Id Acara / Nama Pasangan</label>
    ...
    <div class="card-body">
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <th>pesanan acara belum ada di keranjang</th>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
